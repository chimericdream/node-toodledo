...
describe('FolderModel', () => {
    ...
    describe('fetch()', () => {
        ...
        // http://api.toodledo.com/3/folders/doc_info.php
        describe('when there is an error', () => {
            describe('when a folder ID was not supplied (ERR_CODE 704)', () => {
                xit('is not implemented', () => {
                    expect(true).to.be.false;
                });
            });

            describe('when no folder can be found with the given ID (ERR_CODE 705)', () => {
                xit('is not implemented', () => {
                    expect(true).to.be.false;
                });
            });

            describe('when the folder with the given ID is invalid (ERR_CODE 705)', () => {
                xit('is not implemented', () => {
                    expect(true).to.be.false;
                });
            });
    ...
    describe('create()', () => {
        ...
        // http://api.toodledo.com/3/folders/doc_info.php
        describe('when there is an error', () => {
            describe('when a folder name was not supplied (ERR_CODE 701)', () => {
                xit('is not implemented', () => {
                    expect(true).to.be.false;
                });
            });

            describe('when the max folder limit has been reached (ERR_CODE 703)', () => {
                xit('is not implemented', () => {
                    expect(true).to.be.false;
                });
            });

            describe('when an invalid folder ID is given for the folder (ERR_CODE 707)', () => {
                xit('is not implemented', () => {
                    expect(true).to.be.false;
                });
            });
